...
> この文書は現行の最大4台、2x2合成構成を扱う。マーカー検出をMADSYSTEMから独立させ、10台、20台へ水平拡張し、観客向け映像を注目車両へ切り替える将来計画は [Scalable Marker Observer and Program Observer Design](SCALABLE_MARKER_AND_PROGRAM_OBSERVER_DESIGN.md) を参照する。
